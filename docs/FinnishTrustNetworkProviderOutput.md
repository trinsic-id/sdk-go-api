...
**PhoneNumber** | Pointer to **NullableString** | The phone number of the verified individual.              This is only returned if the user authenticated with MobileID (Mobiilivarmenne). | [optional] 
