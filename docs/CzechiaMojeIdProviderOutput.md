...
### NewCzechiaMojeIdProviderOutputWithDefaults
...
GetOpenId2Identifier returns the OpenId2Identifier field if non-nil, zero value otherwise.

### GetOpenId2IdentifierOk

`func (o *CzechiaMojeIdProviderOutput) GetOpenId2IdentifierOk() (*string, bool)`

GetOpenId2IdentifierOk returns a tuple with the OpenId2Identifier field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetOpenId2Identifier
