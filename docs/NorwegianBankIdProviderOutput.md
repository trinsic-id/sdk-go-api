...
**PersonalIdentifier** | Pointer to **NullableString** | The personal identifier for Norwegian BankID.              This uniquely identifies the user in the Norwegian BankID system and is considered a stable identifier to use. | [optional] 
