...
### NewKenyaNidBiometric2InputWithDefaults
...
`func (o *KenyaNidBiometric2Input) SetIdNumberNil(b bool)`
...
`func (o *KenyaNidBiometric2Input) SetLivenessImagesNil(b bool)`

 SetLivenessImagesNil sets the value for LivenessImages to be an explicit nil

### UnsetLivenessImages
`func (o *KenyaNidBiometric2Input) UnsetLivenessImages()`
...
`func (o *KenyaNidBiometric2Input) SetTestSelfieNil(b bool)`
