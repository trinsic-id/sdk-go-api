...
**RedirectUrl** | Pointer to **string** | The URL to redirect to after the user has completed the identity verification process.                If &#x60;LaunchMethodDirectly&#x60; is set to &#x60;true&#x60;, this field is required. | [optional] 
...
`func (o *CreateSessionRequest) GetRedirectUrl() string`

GetRedirectUrl returns the RedirectUrl field if non-nil, zero value otherwise.

### GetRedirectUrlOk

`func (o *CreateSessionRequest) GetRedirectUrlOk() (*string, bool)`
...
`func (o *CreateSessionRequest) SetRedirectUrl(v string)`

SetRedirectUrl sets RedirectUrl field to given value.

### HasRedirectUrl

`func (o *CreateSessionRequest) HasRedirectUrl() bool`
