...
### NewAustriaValeraEudiSandboxInput

`func NewAustriaValeraEudiSandboxInput() *AustriaValeraEudiSandboxInput`

NewAustriaValeraEudiSandboxInput instantiates a new AustriaValeraEudiSandboxInput object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewAustriaValeraEudiSandboxInputWithDefaults

`func NewAustriaValeraEudiSandboxInputWithDefaults() *AustriaValeraEudiSandboxInput`

NewAustriaValeraEudiSandboxInputWithDefaults instantiates a new AustriaValeraEudiSandboxInput object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetPreviewRaw18013Request

`func (o *AustriaValeraEudiSandboxInput) GetPreviewRaw18013Request() Raw18013RequestInput`
...
`func (o *AustriaValeraEudiSandboxInput) GetPreviewRaw18013RequestOk() (*Raw18013RequestInput, bool)`
