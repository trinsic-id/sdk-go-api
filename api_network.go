...
*/
func (a *NetworkAPIService) ListProviderContracts(ctx context.Context) ApiListProviderContractsRequest {
	return ApiListProviderContractsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *NetworkAPIService) ListProviderContractsExecute(r ApiListProviderContractsRequest) (*ListProviderContractsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/network/providers/contracts"
