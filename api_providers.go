...
func (r ApiGetProviderRequest) Execute() (*GetProviderResponse, *http.Response, error) {
...
*/
func (a *ProvidersAPIService) GetProvider(ctx context.Context, providerId string) ApiGetProviderRequest {
	return ApiGetProviderRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ProvidersAPIService) GetProviderExecute(r ApiGetProviderRequest) (*GetProviderResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/v1/providers/{providerId}"
...
func (r ApiListProvidersRequest) Licensed(licensed bool) ApiListProvidersRequest {
	r.licensed = &licensed
	return r
}
...
func (a *ProvidersAPIService) ListProvidersExecute(r ApiListProvidersRequest) (*ListProvidersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.licensed != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "licensed", r.licensed, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
