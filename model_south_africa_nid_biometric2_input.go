...
// checks if the SouthAfricaNidBiometric2Input type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SouthAfricaNidBiometric2Input{}

// SouthAfricaNidBiometric2Input struct for SouthAfricaNidBiometric2Input
type SouthAfricaNidBiometric2Input struct {
...
type _SouthAfricaNidBiometric2Input SouthAfricaNidBiometric2Input
...
func NewSouthAfricaNidBiometric2Input() *SouthAfricaNidBiometric2Input {
	this := SouthAfricaNidBiometric2Input{}
	return &this
}
...
func (o *SouthAfricaNidBiometric2Input) SetIdNumberNil() {
	o.IdNumber.Set(nil)
}
...
func (o *SouthAfricaNidBiometric2Input) SetTestSelfieNil() {
...
func (o SouthAfricaNidBiometric2Input) MarshalJSON() ([]byte, error) {
...
func (o SouthAfricaNidBiometric2Input) ToMap() (map[string]interface{}, error) {
...
func (o *SouthAfricaNidBiometric2Input) UnmarshalJSON(data []byte) (err error) {
	varSouthAfricaNidBiometric2Input := _SouthAfricaNidBiometric2Input{}

	err = json.Unmarshal(data, &varSouthAfricaNidBiometric2Input)

	if err != nil {
		return err
	}

	*o = SouthAfricaNidBiometric2Input(varSouthAfricaNidBiometric2Input)
...
type NullableSouthAfricaNidBiometric2Input struct {
	value *SouthAfricaNidBiometric2Input
	isSet bool
}

func (v NullableSouthAfricaNidBiometric2Input) Get() *SouthAfricaNidBiometric2Input {
	return v.value
}

func (v *NullableSouthAfricaNidBiometric2Input) Set(val *SouthAfricaNidBiometric2Input) {
	v.value = val
	v.isSet = true
}

func (v NullableSouthAfricaNidBiometric2Input) IsSet() bool {
	return v.isSet
}

func (v *NullableSouthAfricaNidBiometric2Input) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSouthAfricaNidBiometric2Input(val *SouthAfricaNidBiometric2Input) *NullableSouthAfricaNidBiometric2Input {
	return &NullableSouthAfricaNidBiometric2Input{value: val, isSet: true}
}

func (v NullableSouthAfricaNidBiometric2Input) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSouthAfricaNidBiometric2Input) UnmarshalJSON(src []byte) error {
	v.isSet = true
