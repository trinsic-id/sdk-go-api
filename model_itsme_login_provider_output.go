...
// checks if the ItsmeLoginProviderOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItsmeLoginProviderOutput{}

// ItsmeLoginProviderOutput Exposed properties for the `a-itsme-login` Provider which do not directly map to the normalized IdentityData model.
type ItsmeLoginProviderOutput struct {
...
type _ItsmeLoginProviderOutput ItsmeLoginProviderOutput
...
func (o *ItsmeLoginProviderOutput) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ItsmeLoginProviderOutput) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ItsmeLoginProviderOutput) SetDateOfBirthNil() {
...
func (o *ItsmeLoginProviderOutput) SetHashedNationalRegisterNumberNil() {
...
func (o *ItsmeLoginProviderOutput) SetNationalRegisterNumberNil() {
...
func (o *ItsmeLoginProviderOutput) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *ItsmeLoginProviderOutput) SetPhoneNumberNil() {
...
func (o *ItsmeLoginProviderOutput) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ItsmeLoginProviderOutput) SetNationalityNil() {
...
func (o *ItsmeLoginProviderOutput) SetBirthPlaceNil() {
...
func (o *ItsmeLoginProviderOutput) SetDocumentNumberNil() {
...
func (o *ItsmeLoginProviderOutput) SetIdentityDocumentExpirationDateNil() {
...
func (o *ItsmeLoginProviderOutput) SetLanguageNil() {
	o.Language.Set(nil)
}
...
func (o *ItsmeLoginProviderOutput) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o ItsmeLoginProviderOutput) MarshalJSON() ([]byte, error) {
...
func (o ItsmeLoginProviderOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ItsmeLoginProviderOutput) UnmarshalJSON(data []byte) (err error) {
	varItsmeLoginProviderOutput := _ItsmeLoginProviderOutput{}

	err = json.Unmarshal(data, &varItsmeLoginProviderOutput)

	if err != nil {
		return err
	}

	*o = ItsmeLoginProviderOutput(varItsmeLoginProviderOutput)
...
type NullableItsmeLoginProviderOutput struct {
	value *ItsmeLoginProviderOutput
	isSet bool
}

func (v NullableItsmeLoginProviderOutput) Get() *ItsmeLoginProviderOutput {
	return v.value
}

func (v *NullableItsmeLoginProviderOutput) Set(val *ItsmeLoginProviderOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableItsmeLoginProviderOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableItsmeLoginProviderOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItsmeLoginProviderOutput(val *ItsmeLoginProviderOutput) *NullableItsmeLoginProviderOutput {
	return &NullableItsmeLoginProviderOutput{value: val, isSet: true}
}

func (v NullableItsmeLoginProviderOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItsmeLoginProviderOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
