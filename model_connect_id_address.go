...
// checks if the ConnectIdAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectIdAddress{}

// ConnectIdAddress struct for ConnectIdAddress
type ConnectIdAddress struct {
...
type _ConnectIdAddress ConnectIdAddress
...
func (o *ConnectIdAddress) SetStreetAddressNil() {
...
func (o *ConnectIdAddress) SetLocalityNil() {
	o.Locality.Set(nil)
}
...
func (o *ConnectIdAddress) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *ConnectIdAddress) SetCountryNil() {
	o.Country.Set(nil)
}
...
func (o *ConnectIdAddress) SetPostalCodeNil() {
...
func (o ConnectIdAddress) MarshalJSON() ([]byte, error) {
...
func (o ConnectIdAddress) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectIdAddress) UnmarshalJSON(data []byte) (err error) {
	varConnectIdAddress := _ConnectIdAddress{}

	err = json.Unmarshal(data, &varConnectIdAddress)

	if err != nil {
		return err
	}

	*o = ConnectIdAddress(varConnectIdAddress)
...
type NullableConnectIdAddress struct {
	value *ConnectIdAddress
	isSet bool
}

func (v NullableConnectIdAddress) Get() *ConnectIdAddress {
	return v.value
}

func (v *NullableConnectIdAddress) Set(val *ConnectIdAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectIdAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectIdAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectIdAddress(val *ConnectIdAddress) *NullableConnectIdAddress {
	return &NullableConnectIdAddress{value: val, isSet: true}
}

func (v NullableConnectIdAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectIdAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
