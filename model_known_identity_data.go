...
type KnownIdentityData struct {
	...
	Person NullableKnownPersonData `json:"person,omitempty"`
}
...
// SetPerson gets a reference to the given NullableKnownPersonData and assigns it to the Person field.
func (o *KnownIdentityData) SetPerson(v KnownPersonData) {
	o.Person.Set(&v)
}
// SetPersonNil sets the value for Person to be an explicit nil
func (o *KnownIdentityData) SetPersonNil() {
	o.Person.Set(nil)
}
